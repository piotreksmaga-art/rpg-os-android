...
data class ActiveGameMasterRepository(
    ...
    val semanticMemoryConsolidator: SemanticMemoryConsolidator141? = null
) : AutoCloseable {
...
class GameMasterRepositoryFactory(
    ...
    private fun openSession(requireOpenIntegrity: Boolean): ActiveGameMasterRepository {
        ...
        return try {
            ...
            val semanticMemoryConsolidator = SemanticMemoryConsolidator141(
                db = db,
                campaignUid = campaignUid,
            ...
            ActiveGameMasterRepository(
                ...
                semanticMemoryConsolidator = semanticMemoryConsolidator
            )
        } catch (t: Throwable) {
