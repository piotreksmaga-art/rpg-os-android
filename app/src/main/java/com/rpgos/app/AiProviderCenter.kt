...
fun openRouterFailureMessagePl(reasonUid:String?)=when(reasonUid){
    ...
    "OPENROUTER_AUTH_HTTP2_PROTOCOL"->"Połączenie HTTP/2 z OpenRouter zostało zerwane. Ta wersja aplikacji używa zgodnego transportu HTTP/1.1 przy następnej próbie."
    "OPENROUTER_AUTH_CONNECTION_RESET"->"Połączenie z OpenRouter zostało przerwane przez sieć lub serwer pośredniczący."
