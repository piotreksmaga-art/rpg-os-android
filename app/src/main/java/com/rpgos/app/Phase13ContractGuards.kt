...
fun MigrationManager.ensureV13ContractGuards(saveDb: SQLiteDatabase, campaignId: String) {
    ...
    try {
        ...
        // Refresh the account insert authority to include a registered account-type namespace.
        ...
        saveDb.execSQL("INSERT OR IGNORE INTO rpgos_schema_migrations(migration_id,applied_at,notes) VALUES('$PHASE13_CONTRACT_GUARD_MIGRATION_ID',strftime('%s','now'),'Registers account-type namespace and freezes currency precision/type meaning after first use; only explicit retirement lifecycle remains legal')")
