...
- [-] 62. NPC Decision Engine + knowledge/memory/social-role constrained autonomy `[REF-ADAPTER]`
  ...
  Lokalna implementacja 61–62: trwały Brain, role/cele/emocje, bounded holder recall, decyzje i plany przez Phase60, osobna ścieżka rozmowy NPC oraz ograniczony odzysk własnego zasobu przez Phase50 po ukończeniu zarejestrowanej czynności. Szczegóły i nierozwiązane bramki: [PHASE61_62_NPC_IMPLEMENTATION.md](architecture/PHASE61_62_NPC_IMPLEMENTATION.md). Status pozostaje PARTIAL; nie jest to odbiór pełnego bloku ani wydanie.
